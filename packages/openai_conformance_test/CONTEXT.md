...
- The freeze comes from [issue #208](https://github.com/webai-at-home/webai-at-home/issues/208), which merged this package and `packages/openai_api_tool` into `packages/openai_test`. A follow-up issue deletes both.
