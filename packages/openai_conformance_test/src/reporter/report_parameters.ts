 ...
 *
 * Declared here rather than imported from `../cli.ts` so that a reporter never depends on the
 * command line program that happens to call it. `RawCliOptions` satisfies this shape already.
 */
