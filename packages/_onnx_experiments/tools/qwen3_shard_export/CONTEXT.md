...
Splits the published Qwen3-0.6B ONNX model into three independent graphs, and checks the three against the original. This supports the `public/onnxruntime_qwen3-0.6b-with-shards` experiment.
...
- This folder has nothing to do with [issue #169](https://github.com/webai-at-home/webai-at-home/issues/169), which every other folder under `tools/` belongs to.
