...
- [`public/gemma4-e2b-json-grammar-gate`](public/gemma4-e2b-json-grammar-gate) — Gemma 4 E2B masked by a JSON grammar through a `logits_processor`, on WebGPU only, issue #219 de-risk gate.
- [`public/gemma4-e2b-json-schema-measurement`](public/gemma4-e2b-json-schema-measurement) — Gemma 4 E2B held to a JSON Schema by the same masking, measuring required keys, declared types, and enumerations, on WebGPU only, issue #219 milestone 6.
