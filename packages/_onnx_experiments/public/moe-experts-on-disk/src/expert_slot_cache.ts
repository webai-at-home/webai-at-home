import type { BlockPart } from './model_types.js';
...
/**
 * The expert cache of milestone 4 of https://github.com/webai-at-home/webai-at-home/issues/169, copied here unchanged
 * apart from where it reads its types from. Copying rather than sharing is this package's rule: each experiment is
 * standalone, and a shared library across experiments would make one page's change another page's problem. Milestone
 * 5 wants exactly the cache milestone 4 measured, and a copy is what guarantees it keeps having it.
 *
