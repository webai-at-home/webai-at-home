...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
//	JsonSchemaMaskCache — works out which entries of the vocabulary a schema grammar state allows, once
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
...
export class JsonSchemaMaskCache {
	 ...
	 * because a mask is what a state of **this** schema allows and means nothing under another.
	 */
	...
	private _workOutMask(state: JsonSchemaGrammarState, signature: string): GrammarMask {
		...
		for (let tokenId = 0; tokenId < size; tokenId = tokenId + 1) {
			...
			if (JsonSchemaGrammar.acceptsText(this.nodes, state, this.vocabularyTable.textOf(tokenId)) === true) {
				isLegal[tokenId] = 1;
