...
/**
 * One Qwen3-30B-A3B expert at 4 bits, in bytes, as measured by `tools/measure_qwen3_moe_residency.mjs` in milestone
...
class Main {
	...
	/**
	 * Formats a byte count, in the same units of 1024 that `tools/measure_qwen3_moe_residency.mjs` reports.
	 *
