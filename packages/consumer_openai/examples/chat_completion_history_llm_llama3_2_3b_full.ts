...
//
// The model `llm_llama3_2_3b_full` is one of the three models whose task type accepts a whole
// conversation rather than only one prompt (`llm_qwen3_5_0_8b_full` and `llm_llama3_2_1b_full` are
// the other two; see `examples/chat_completion_history_llm_qwen3_5_0_8b_full.ts` and
