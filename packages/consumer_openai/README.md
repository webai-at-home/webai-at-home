...
| `llm_gemma_4_e2b_full` | None, and for a different reason from the rest of this table: nothing about it has been measured. [Issue #211](https://github.com/webai-at-home/webai-at-home/issues/211) built and proved this model end to end but never gated its generation controls. This table records what a live run observed, so the row stays empty and a request asking for any of the six is refused, rather than being filled in from what `llm_qwen3_5_0_8b_full` does on the same engine. |
