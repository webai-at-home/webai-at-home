 ...
 * [issue #219](https://github.com/webai-at-home/webai-at-home/issues/219). The de-risk gate of
 * milestone 0 has a reader of its own, in
 * `packages/_onnx_experiments/public/gemma4-e2b-json-grammar-gate/src/`, and this one is written
 * again here rather than imported, because no working package may import from
 * `packages/_onnx_experiments`. `gemma_4_e2b_tool_call_reader.ts` exists in both places for the
 * same reason.
 */
