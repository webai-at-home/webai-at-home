...
```bash
openai_test benchmark --base_url http://localhost:11434/v1 --model gemma4:e2b --format markdown --output data/benchmark_reports/ollama_gemma4_e2b.benchmark_report.md
```
...
| `--warmup_runs` | 1 |
| `--thinking` | off |
| `--output` | data/benchmark_reports/ollama_gemma4_e2b.benchmark_report.md |
