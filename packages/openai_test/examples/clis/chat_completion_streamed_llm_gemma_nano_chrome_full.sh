...
###############################################################################
###############################################################################
#	Shows the answer of the language model built into Chrome arriving as it is written
###############################################################################
###############################################################################

# Run with:
#   npm run example:cli:chat_completion_streamed_llm_gemma_nano_chrome_full --workspace @webai/openai-test
#
...
# pipeline can manage, which `examples/clis/chat_completion_nostream_llm_gemma_nano_chrome_full.sh` shows.
