...
###############################################################################
###############################################################################
#	Shows the complete Qwen3.5-0.8B model answer arriving as it is written
###############################################################################
###############################################################################

# Run with:
#   npm run example:cli:chat_completion_streamed_llm_qwen3_5_0_8b_full --workspace @webai/openai-test
#
...
# profile downloads about 600 MB of model files; later requests reuse the browser's cache.
#
...
# pipeline can manage, which `examples/clis/chat_completion_nostream_llm_qwen3_5_0_8b_full.sh` shows.
