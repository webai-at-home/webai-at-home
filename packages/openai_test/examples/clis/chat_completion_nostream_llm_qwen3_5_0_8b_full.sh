...
# Run with:
#   npm run example:cli:chat_completion_nostream_llm_qwen3_5_0_8b_full --workspace @webai/openai-test
#
...
# which `examples/clis/chat_completion_streamed_llm_qwen3_5_0_8b_full.sh` shows.
