...
// Run with:
//   npm run example:ts:chat_completion_nostream_llm_qwen3_5_0_8b_full --workspace @webai/openai-test
//
...
// which `examples/typescript/chat_completion_streamed_llm_qwen3_5_0_8b_full.ts` shows.
