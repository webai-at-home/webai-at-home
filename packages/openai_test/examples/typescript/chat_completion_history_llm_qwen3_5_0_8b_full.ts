...
// Run with:
//   npm run example:ts:chat_completion_history_llm_qwen3_5_0_8b_full --workspace @webai/openai-test
//
...
// other two; see `examples/typescript/chat_completion_history_llm_llama3_2_1b_full.ts` and
// `examples/typescript/chat_completion_history_llm_gemma_4_e2b_full.ts`). Sending several messages here does
