...
export type CompletionResult = {
	 ...
	 * an embedding model, or a name that does not exist at all — with HTTP 200 generated by whichever
	 * model happens to be loaded, and names that substitute here. See
	 * [issue #208](https://github.com/webai-at-home/webai-at-home/issues/208).
	 *
	 * `undefined` when the endpoint named no model at all.
	 */
