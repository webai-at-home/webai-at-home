...
- The absolute "never read an answer's content" rule this refines could not survive: `parameters/` and `tools/` already read content. See [issue #208](https://github.com/webai-at-home/webai-at-home/issues/208).
