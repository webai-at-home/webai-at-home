...
- `worker_page_origin.ts`: `WorkerPageOrigin` and `defaultWorkerPort`, which work out the address the worker webpage is reachable at, from wherever the calling page was opened, and point a page's Worker links at it.
