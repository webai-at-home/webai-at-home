...
- [`packages/openai_api_tool_TOREMOVE`](packages/openai_api_tool_TOREMOVE/), [`packages/docker_server`](packages/docker_server/), [`packages/flow_viewer`](packages/flow_viewer/), and the `packages/_*` experiments, among them [`packages/_codex_experiments`](packages/_codex_experiments/), which runs the Codex command-line program against a small local model.
